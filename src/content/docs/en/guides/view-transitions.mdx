...
WebGL/WebGL2 canvas context is preserved during persist swaps. In browsers that support [`moveBefore()`](https://developer.mozilla.org/en-US/docs/Web/API/Element/moveBefore), all live element state (focus, animations, etc.) is atomically preserved.
:::
